    ...
    <div class="flex justify-between items-center px-4 py-6 sm:px-6 md:justify-start md:space-x-10">
        <div>
            <a href="#" class="flex">
                ...
                <img class="h-8 w-auto sm:h-10" src="https://tailwindui.com/img/logos/workflow-mark-gray-600.svg" alt="">
            </a>
        </div>
        ...
        <div class="hidden md:flex-1 md:flex md:items-center md:justify-between">
            <nav class="flex space-x-10">
                ...
                <a href="{{ route('start.index') }}" class="text-base font-medium text-gray-500 hover:text-gray-900">
                    Start
                </a>
