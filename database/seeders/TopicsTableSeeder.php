...
class TopicsTableSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        $services = Service::where('id',7)->get();
        ...
        foreach ($services as $service)
        {
            Topic::create([
                ...
                'order' => 1,
                'title' => 'Data Storage',
                'question' => 'Do you keep data from contact forms?',
            ...
            Topic::create([
                ...
                'published' => true,
                'order' => 2,
                'title' => 'Simple and straightforward language',
                'question' => 'Do you use simple and straightforward language on your forms?',
                'description' => 'Lorem Ipsum',
                'value' => 0,
            ...
            Topic::create([
                ...
                'question' => 'Does it have granular consent options?',
                'description' => 'Lorem Ipsum',
                'value' => 0,
                'body' => 'The GDPR mandates accountability and recognizes only relevant, informed, and freely given consent as legitimate. Your users won\'t be able to give informed consent if they don\'t understand what they\'re signing up for.',
            ]);
